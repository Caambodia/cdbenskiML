...
volume_2 = Conv2D(128, (1,1), padding='same', activation='relu')(input_img)
volume_2 = Conv2D(128, (3,3), padding='same', activation='relu')(volume_2)

volume_3 = Conv2D(128, (1,1), padding='same', activation='relu')(input_img)
...
volume_5 = Conv2D(128, (1,1), padding='same', activation='relu')(volume_5)

# Concatenate all volumes of the Inception module
inception_module = keras.layers.concatenate([volume_2, volume_3,
                                             volume_5], axis = 3)
